...
from autosail.common.decorators import validate_X_y
from autosail.common.helper import VerboseManager
from autosail.drift_detection.drift_detector import SAILDriftDetector
from autosail.models.auto_ml.base_strategy import PipelineActionType, PipelineStrategy
from autosail.models.auto_ml.pipeline_strategy import DetectAndIncrement
from autosail.models.auto_ml.tune import SAILTuneGridSearchCV, SAILTuneSearchCV
from autosail.models.base import SAILModel
from autosail.pipeline import SAILPipeline
from autosail.telemetry import TracingClient
from autosail.utils.logging import configure_logger
from autosail.utils.serialization import load_obj, save_obj
    ...
    def _resolve_search_method(self, search_method, search_method_params):
        if search_method is None:
            ...
            raise TypeError(
                ...
                f"[SAILTuneGridSearchCV, SAILTuneSearchCV] from autosail.models.auto_ml.tune. Got {search_method.__module__}.{search_method.__class__.__qualname__}. Set `None` to use the default."
            )
